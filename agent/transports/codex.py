        ...
        if reasoning_enabled and is_xai_responses:
            ...
            if is_github_responses:
                ...
                if github_reasoning is not None:
                    ...
                    # the non-GitHub branch below already avoids. Reported
                    # against api.githubcopilot.com /responses in #46527: the
                    # summary is only emitted when summary="auto" is sent. An
                    # explicit summary in the caller's extras still wins.
                    kwargs["reasoning"] = {"summary": "auto", **github_reasoning}
            else:
